#!/usr/bin/env python3
"""
CityPulse Supabase Migration Runner (Python)
...
def run_migration():
    ...
    # Resolve migration SQL file path
    sql_file = Path(__file__).resolve().parent / "migrations" / "001_initial_schema.sql"
    if not sql_file.exists():
        sql_file = Path(__file__).resolve().parent.parent / "supabase" / "migrations" / "001_initial_schema.sql"
